...
<head>
  ...
  <link rel="stylesheet" href="/media/Css/Confirmacao_Cadastro.css">
</head>
<body>
  <header>
    <!-- Cabeçalho da página -->
  ...
  <div class="background">
    <div class="titulo-wrapper">
      <h1 class="titulo-confirmacao">Confirmação de Cadastro</h1>
    </div>
    <div class="verification-container">
      <img class="check-icon" src="/media/Ícone_Check_Branco.png" alt="Ícone de confirmação">
      <p>Seu cadastro foi concluído com sucesso! Agora você pode acessar todas as funcionalidades disponíveis.</p>
