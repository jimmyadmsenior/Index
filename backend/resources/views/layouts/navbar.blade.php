<header class="navbar-index" style="background:#111; width:100%; min-width:0; box-shadow:none; border:none; margin:0; padding:0; position:relative; z-index:1001;">
  <div class="navbar-content" style="width:100%;padding:0;">
    <div style="display:grid;grid-template-columns:1fr auto 1fr;align-items:center;max-width:1300px;width:100%;margin:0 auto;padding:0 32px 0 32px;height:64px;box-sizing:border-box;">
      <div style="justify-self:start;">
        <a href="/Homepage_Com_Cadastro"><img src="/media/Logo_Branca.png" alt="Logo Index" style="height:32px;"></a>
      </div>
      <nav class="navbar-menu" style="justify-self:center;">
        <ul style="display:flex;gap:32px;margin:0 auto;padding:0;list-style:none;">
      ...
      <div class="navbar-actions" style="display:flex;align-items:center;gap:18px;justify-self:end;margin-left:40px;padding-left:16px;">
