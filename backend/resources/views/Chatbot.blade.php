  ...
  <header style="background:#111;box-shadow:none;border:none;">
    <div class="header-content">
      ...
      <nav style="background:#111;">
        <ul class="menu">
          <li><a href="/categoria/smartphones" style="color:#fff;background:#111;">Smartphones</a></li>
          <li><a href="/categoria/tablets" style="color:#fff;background:#111;">Tablets</a></li>
          <li><a href="/Homepage_Fones" style="color:#fff;background:#111;">Fones</a></li>
          <li><a href="/categoria/relogios" style="color:#fff;background:#111;">Relógios</a></li>
          <li><a href="/categoria/notebooks" style="color:#fff;background:#111;">Notebooks</a></li>
        </ul>
      </nav>
      <div class="icons">
