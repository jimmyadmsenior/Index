...
<main class="background">
  <div class="verification-container">
    ...
    <form method="POST" action="/recuperacao-senha-email" onsubmit="return validarCampo()">
      @csrf
      <div class="input-container" id="campo-email">
        <input class="input-field" type="email" id="input-field" name="email" placeholder=" " required>
